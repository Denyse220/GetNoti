...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="sign.php" method="POST">
            ...
            <input type="date" placeholder="starting date" name="sdate"/>
			<label>Closing Date</label>
			<input type="date" placeholder="Closing date" name="cdate"/>
			<label>Email</label>
			...
			<input type="password" placeholder="Comfirm Password"name="cpwd" />
			<button type="button" name="regi">Sign Up</button>
		</form>
	</div>
